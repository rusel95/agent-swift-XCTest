...
- [ ] T021 Update RPListener.testBundleDidFinish for finish coordination in Sources/RPListener.swift
  - Create WorkerTracker and FinishCoordinator instances
  - Register worker at bundle start (testBundleWillStart)
  - Record status at bundle finish
  - Check if should finish launch
  - Call ReportingService.finishLaunch only if last worker
